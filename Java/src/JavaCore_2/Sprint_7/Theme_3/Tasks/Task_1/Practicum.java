package JavaCore_2.Sprint_7.Theme_3.Tasks.Task_1;
...
public class Practicum {
    ...
    public static void main(String[] args) {
        ...
        Predicate<String> filter1 = line -> line.contains("ВАЖНО");

        Predicate<String> filter2 = line -> line.endsWith("!");


        saver.setOnSaveListener(accept);
        saver.addFilter(filter1);
